...
namespace KlingoTest
{
    public static class KlingoLanguage
    {
        ...
        public static List<KlingoWord> WordInitializer(List<string> words)
        {
            ...
            {
                results.Add(new KlingoWord(word));
            }

            return results;
        }

        public static string KlingoWordsListToText(List<KlingoWord> words)
        {
            string result = "";
            foreach (KlingoWord word in words)
            {
